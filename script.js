...
for (let i = 0; i < dropList.length; i++) {
    for(let currency_code in country_list){
        ...
        let selected = i == 0 ? currency_code == "GBP" ? "selected" : "" : currency_code == "INR" ? "selected" : "";
...
function getExchangeRate(){
    ...
    let url = `https://v6.exchangerate-api.com/v6/a3e957f7bac74811dcf25df2/latest/${fromCurrency.value}`;
